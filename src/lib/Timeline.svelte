<script>
  ...
  $: if (xAxisGroup) {
    ...
    sel.selectAll("text").attr("text-anchor", "centre").attr("dx", "-0.6em");
  }
...
<div class="timeline" bind:clientWidth={width} bind:clientHeight={height}>
  <h2 style="text-align: center;">
    Russian Mediation and Mediation-Related Activity Over Time
  </h2>
  <div class="timeline_legend">
    ...
    <div class="legend-item one">
      <span class="legend-circle" style="background-color: yellow; "></span>
      Selected Country
    </div>
  </div>
